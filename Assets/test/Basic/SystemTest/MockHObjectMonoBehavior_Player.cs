...
namespace HAN.Lib.Testing
{
     ...
     */
    public class MockHObjectMonoBehavior_Player : HObjectMonoBehavior
    {
        /**
        ...
        private class MockHObject : HObject
        {
            ...
            public MockHObject()
            {
                m_health = new SignalizingProperty<int>( KeyFactory.Create( "Health" ), 100, this );
                AddProperty( m_health );

                m_armor = new SignalizingProperty<int>( KeyFactory.Create( "Armor" ), 10, this );
                AddProperty( m_armor );


                m_weapon = new SignalizingProperty<Key>( KeyFactory.Create( "Weapon" ), KeyFactory.Create( "Gauss Rifle" ), this );
                AddProperty( m_weapon );


                m_name = new Property<string>( KeyFactory.Create( "Name" ), "Fallout Stranger" );
                AddProperty( m_name );
            }
        ...
        public MockHObjectMonoBehavior_Player()
        {
