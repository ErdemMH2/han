...
{
    /**
     * Generic IGenericSignalConnection 
     */
    public class GenericSignalConnection<T> : IGenericSignalConnection
                                              where T : Delegate
    {
        public T Slot { get { return m_slot; } }

        public IGenericSignal Signal { get { return m_signal; } }

        public IGenericSignalHandler Sender { get { return m_sender; } }
        public IGenericSignalHandler Receiver { get { return m_receiver; } }
        ...
        public GenericSignalConnection( IGenericSignalHandler a_sender
        ...
        {
            if( System.Object.ReferenceEquals( this, a_otherConnection ) ) {
                return true;
            }

            if( a_otherConnection is GenericSignalConnection<T> connection )
            {
